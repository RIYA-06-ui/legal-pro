        ...
        >
          ...
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 dark:border-gray-700/20 overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-emerald-600 to-teal-600 p-8 text-center">
              ...
              >
                <h1 className="text-2xl font-bold text-white mb-2">Join LegalPro</h1>
                <p className="text-emerald-100">Create your account and get started</p>
              </motion.div>
            </div>
            ...
            <div className="p-8">
              ...
              >
                <p className="text-gray-600 dark:text-gray-400 text-lg leading-relaxed">
                  Join thousands of users who trust LegalPro for their document analysis and security needs.
                </p>
              </motion.div>
